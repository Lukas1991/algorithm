...
public class checkNumeric {
	 ...
	 public boolean isNumber2(String s){
		 ...
		 if(Pattern.compile("[^\\d\\.\\+\\-eE]").matcher(s).find()) return false;
	...
	public static void main(String[] args) {
		...
		//The backslash \ is an escape character in Java Strings.  You have to use double backslash \\ to define a single backslash \\d,\\s

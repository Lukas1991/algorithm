...
public class FindCelebrity {
     ...
     *
     * Now you want to find out who the celebrity is or verify that there is not one. The only thing you are allowed to do is to ask
     * questions like: "Hi, A. Do you know B?" to get information of whether A knows B. You need to find out the celebrity (or
    ...
    public int findCelebrity(int n) {
        ...
        for (int i = 1; i < n; i++) {
            if (!knows(i, candidate)) { //can also use if(knows(candidate, i)), both are accepted
                candidate = i;
            }
        }
